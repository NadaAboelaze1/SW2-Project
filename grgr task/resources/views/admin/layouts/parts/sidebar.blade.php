...
<head>
    ...
    <link rel="stylesheet" href="{{asset('adminStyle/assets/css/cs-skin-elastic.css')}}">
    ...
    <!-- /#left-panel -->
     <!-- <li class="nav-item">
        <a href="{{url('/admin/home')}}" class="nav-link">
            <i class="icon-pencil"></i> Home Page</a>
    </li> -->
    <!-- <li class="nav-item">
        <a href="{{url('/admin/add')}}" class="nav-link">
            <i class="icon-pencil"></i> Add Employee</a>
    </li> -->
    <!-- <li class="nav-item">
        <a href="{{url('/admin/listEmployees')}}" class="nav-link">
            <i class="icon-pencil"></i> List Employees</a>
    </li> -->